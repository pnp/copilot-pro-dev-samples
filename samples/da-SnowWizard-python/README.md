# Copilot Snow Wizard (Python)

## Summary

This sample project demonstrates an implementation of an M365 Declarative Copilot that interfaces with ServiceNow to list and create incidents using Python and Azure Functions.
...
-------|----|--------
1.0|May 25, 2026|Initial release
...
Please note that the code is limiting the return from the ServiceNow interface in just 10 incidents. That can be easily changed by adjusting the limit on the service interface implemented by snow_incidents.py.
